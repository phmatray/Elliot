...
public struct ClientInfo: Codable, Sendable {
    ...
    public init(
        name: String, title: String? = nil, version: String? = nil, _meta: [String: AnyCodable]? = nil
    ) {
        self.name = name
        self.title = title
    ...
    public init(from decoder: Decoder) throws {
        ...
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .type, in: container, debugDescription: "Unknown MCP server type: \(type)")
        }
    }
...
public struct StdioServerConfig: Codable, Sendable {
    ...
    public init(
        name: String, command: String, args: [String], env: [EnvVariable], _meta: [String: AnyCodable]? = nil
    ) {
        self.name = name
