...
public struct Annotations: Codable, Sendable {
    ...
    public init(
        audience: [String]? = nil, lastModified: String? = nil, priority: Int? = nil,
...
public struct ImageContent: Codable, Sendable {
    ...
    public init(
        data: String, mimeType: String, uri: String? = nil, annotations: Annotations? = nil,
        _meta: [String: AnyCodable]? = nil
    ) {
        self.data = data
...
public struct AudioContent: Codable, Sendable {
    ...
    public init(
        data: String, mimeType: String, annotations: Annotations? = nil, _meta: [String: AnyCodable]? = nil
    ) {
        self.data = data
        self.mimeType = mimeType
        self.annotations = annotations
...
public struct ResourceLinkContent: Codable, Sendable {
    ...
    public init(
        uri: String, name: String, title: String? = nil, description: String? = nil, mimeType: String? = nil,
        size: Int? = nil, annotations: Annotations? = nil, _meta: [String: AnyCodable]? = nil
    ) {
        self.uri = uri
        self.name = name
        self.title = title
...
public enum EmbeddedResourceType: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .type, in: container, debugDescription: "Unknown resource type: \(type)")
        }
    }
...
public struct ResourceContent: Codable, Sendable {
    ...
    public init(
        resource: EmbeddedResourceType, annotations: Annotations? = nil, _meta: [String: AnyCodable]? = nil
    ) {
