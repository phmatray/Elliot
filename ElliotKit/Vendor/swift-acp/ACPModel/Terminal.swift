...
public struct CreateTerminalRequest: Codable, Sendable {
    ...
    public init(
        command: String, sessionId: String, args: [String]? = nil, cwd: String? = nil,
        env: [EnvVariable]? = nil, outputByteLimit: Int? = nil, _meta: [String: AnyCodable]? = nil
    ) {
...
public struct TerminalOutputResponse: Codable, Sendable {
    ...
    public init(
        output: String, exitStatus: TerminalExitStatus? = nil, truncated: Bool,
