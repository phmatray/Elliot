...
public actor ProcessRegistry {
    ...
    public func recordProcess(pid: Int32, pgid: Int32?, agentPath: String) {
        ...
        entries.append(
            Entry(pid: pid, pgid: pgid, agentPath: agentPath, startedAt: Date().timeIntervalSince1970))
    ...
    private func parsePsOutput(args: [String]) -> [(pid: Int32, command: String)] {
        ...
        for line in lines {
            ...
            let command =
                parts.count > 1 ? String(parts[1]).trimmingCharacters(in: .whitespacesAndNewlines) : ""
