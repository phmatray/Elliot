...
- **Full test:** `cd ElliotKit && swift test` (**1175 tests in 136 suites**, 5 of 5 samples on
  `fix/168-socket-path-too-long` on 2026-08-07 off `main` at `0902c10`; needs no Xcode,
